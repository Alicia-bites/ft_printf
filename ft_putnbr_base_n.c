...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/10 13:47:59 by amarchan          #+#    #+#             */
/*   Updated: 2021/12/10 20:15:11 by amarchan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_print(int *nbr_final, int nbr,
...
int	ft_putnbr_base_n(int nbr, char *base)
{
	...
	nbr_final = (int *)malloc(sizeof(int) * nbr_size);
	if (!nbr_final)
			return (0);
